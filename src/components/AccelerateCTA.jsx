    ...
    <section className="relative bg-white text-neutral-900 py-10 sm:py-14 border-t border-neutral-200 overflow-hidden font-['Inter',sans-serif]">
      ...
      <div className="w-full px-4 sm:px-8 lg:px-12 relative z-10">
        <motion.div
          ...
          className="w-full bg-neutral-50/90 border border-neutral-200 rounded-2xl p-6 sm:p-8 lg:p-10 shadow-sm hover:shadow-md transition-shadow duration-300 relative overflow-hidden"
        >
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-center">
            {/* Left Column: Heading without red color */}
            <div className="lg:col-span-6 space-y-3">
              <span className="inline-flex items-center gap-1.5 text-[11px] font-bold text-neutral-600 uppercase tracking-[0.22em]">
                <Sparkles className="h-3 w-3 text-neutral-800" />
                <span>Next Generation Transformation</span>
              </span>
              <h2 className="text-2xl sm:text-3xl lg:text-[34px] font-extrabold text-neutral-950 tracking-tight leading-[1.2]">
              ...
              <div className="w-16 h-0.5 bg-neutral-900 rounded-full" />
            </div>
            ...
            <div className="lg:col-span-6 space-y-4">
              ...
              <div>
                <button
                  ...
                  className="inline-flex items-center gap-2.5 px-6 py-3 bg-neutral-950 hover:bg-neutral-800 text-white font-bold text-xs uppercase tracking-[0.16em] rounded-xl shadow-md hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200 cursor-pointer group/btn"
                >
